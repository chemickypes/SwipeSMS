...
import com.baraccasoftware.swipesms.app.service.MessagingService;
...
public class MessagingReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        defaultApp = PreferenceManager.getDefaultSharedPreferences(context).getBoolean("default_app",false);
